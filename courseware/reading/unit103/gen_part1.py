...
q6 = ('<div class="practice-mcq" id="q6-box"><div class="pmcq-label">Q6 · Summary cloze · 7 marks '
      ...
      + '</div>'
      '<div class="pmcq-q">Complete the summary of paragraphs 3 and 4 by writing <strong>ONE word</strong> in each '
      'blank. You should make sure your answers are grammatically correct.</div>'
      '<div class="card" style="padding:14px 18px;font-size:18px;line-height:1.9">'
      '<p style="font-weight:700;font-size:20px;margin:0 0 10px">Paying Attention</p>'
      '<p>Surprisingly, the human brain finds it (i) ' + cloze("difficult / hard / challenging / problematic")
      + ' to think about one thing for long periods of time.</p>'
      '<p style="margin:6px 0 2px">The brain has two attention systems:</p>'
      '<p style="margin:4px 0"><strong>1. The Conscious System</strong><br>'
      'It helps people to focus and is related to higher reasoning. It operates at a (ii) '
      + cloze("slower / lower") + ' speed.</p>'
      '<p style="margin:4px 0"><strong>2. The Unconscious System</strong><br>'
      'It helps people to notice anything that our senses consider (iii) '
      + cloze("significant / important / vital / crucial") + '. It is linked to how our (iv) '
      + cloze("emotions / senses") + ' guide the processing of our surroundings. The system is (v) '
      + cloze("still / always / also") + ' functioning even when we are focusing on something else.</p>'
      '<p>We are easily distracted by unexpected noises even when the distraction is not as (vi) '
      + cloze("stimulating / interesting") + ' as the task we are engaged in. When the task is boring, '
      'this distraction is even (vii) ' + cloze("stronger / greater") + '.</p>'
      '</div>'
...
q17 = ('<div class="practice-mcq" id="q17-box"><div class="pmcq-label">Q17 · Timeline cloze · 6 marks '
       ...
       '<div class="pmcq-q">Based on the information in paragraphs 11–12, complete the timeline of the development of '
       'video game soundtracks using <strong>ONE word</strong> from the text for each blank.</div>'
       '<table class="quiz-table"><tr><th style="width:22%">Stage</th><th>Development</th></tr>'
       '<tr><td><strong>Early video games</strong></td><td>At the start, technological (i) '
       + cloze("limitations") + ' resulted in the use of somewhat (ii) ' + cloze("simplistic") + ' music.</td></tr>'
       '<tr><td><strong>Next 10–20 years</strong></td><td>Game soundtracks improved so they were (iii) '
       + cloze("entertaining / pleasant") + ' without being (iv) ' + cloze("distracting") + ' for the players.</td></tr>'
       '<tr><td><strong>Latest development</strong></td><td>With advances in (v) ' + cloze("technology")
       + ' the game producers are choosing from a wider range of music. The difficulty is keeping the (vi) '
       + cloze("balance / stimulation") + ' right so players enjoy the music whilst focusing on their game.</td></tr>'
       '</table>'
